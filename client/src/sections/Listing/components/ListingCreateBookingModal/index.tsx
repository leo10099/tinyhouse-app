  ...
  const handleCreateBooking = async () => {
    if (!stripe) {
      return displayErrorMessage(
        "Sorry! We weren't able to connect with Stripe. Please try again."
      );
    }
      ...
      createBooking({
        variables: {
          input: {
            ...
            checkIn: moment(checkInDate).format("MM-DD-YYYY"),
            checkOut: moment(checkOutDate).format("MM-DD-YYYY"),
          },
        },
      });
    } else {
  ...
  return (
    ...
    >
      <div className="listing-booking-modal">
        ...
        <div className="listing-booking-modal__charge_summary">
          <Paragraph>
